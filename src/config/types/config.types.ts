...
export type ConfigLoadResult
  = | { readonly state: 'ok'; readonly config: AgentWatchConfig; readonly warnings: readonly string[] }
    | { readonly state: 'missing'; readonly config: AgentWatchConfig; readonly warnings: readonly string[] }
    | { readonly state: 'invalid'; readonly error: string; readonly config: AgentWatchConfig; readonly warnings: readonly string[] };
